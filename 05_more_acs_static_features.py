...
TARGET_TABLES_FN = "data/raw/acs_table_list.csv"
RAW_SAVE_FN      = "data/raw/raw_acs5_data.csv" # Just for now.
OUTPUT_FN_TEMP   = "data/raw/{}_static_features_by_fips.csv"
...
for year in YEARS:
	...
	raw_df = cd.download('acs5', year, all_counties, target_tables)
	...
	## Save it!
	raw_df[keep_columns].to_csv(OUTPUT_FN_TEMP.format(year))
